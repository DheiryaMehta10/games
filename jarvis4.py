...
import os
import os.path
import requests #pip insatall requests
...
def sendEmail(to,content):
    ...
    server.ehlo()
    server.starttls()
    server.login('', '') #your gmail account and password
    server.sendmail('', to, content) #senders gmail account
    server.close()
    ...
    def TaskExecution(self):
        ...
        while True:
            ...
            if "open notepad" in self.query:
                npath = "C:\\Windows\\notepad.exe" #the directory of notepad.exe
                os.startfile(npath)

            elif "open adobe reader" in self.query:
                apath = "" #the directory of adobe reader.exe
                os.startfile(apath)
                ...
                music_dir = "" #the directory of the song folder
                ...
                webbrowser.open(f"{cm}")
                 ...
                 kit.sendwhatmsg("", "Hii What's Up",13,30) #senders name , message ,time
                 time.sleep(120)
            ...
            # elif "email to dheirya" in self.query:
            #      try:
            #          speak("what should i say?")
            #          content = takecommand()
            #          to = "EMAIL OF THE OTHER PERSON"
            #          sendEmail(to,content)
            #          speak("Email has been sent to asha")
            ...
            #     os.system("rundll32.exe powrprof.dll,SetSuspendState 0,1,0")
            ...
            elif "email to dheirya" in self.query: #the senders name 
                ...
                if "send a file" in self.query:
                    ...
                    send_to_email = '' # Whom you are sending the message to
                    ...
                    password = '' # Your email account password
                    send_to_email = '' # Whom you are sending the message to
                    message = 'hey i am just testing jarvis is it working properly' # The message in the email
...
class Main(QMainWindow):
    ...
    def startTask(self):
        self.ui.movie = QtGui.QMovie("C:\\Users\\dheir\\OneDrive\\Pictures\\Screenshots\\7LP8.gif") #Enter directory of the file gif
        self.ui.label.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie("C:\\Users\\dheir\\OneDrive\\Pictures\\Screenshots\\28c2aacf19e8c1f7d23294850c1084de0fe13445d014375d08f9a272e96d83bd.0.GIF") #Enter the directory of gif jarvis
